...
def _generate_model_card(model_name, env_id, mean_reward, std_reward):
    ...
    # Adding the metrics
    metrics = metadata_eval_result(model_pretty_name=model_name,
  ...
  """
    ...
    return model_card, metrics


def _save_model_card(repo_dir: Path, generated_model_card, metrics):
    """Saves a model card for the repository.
    :param repo_dir: repository directory
    :param generated_model_card: model card generated by _generate_model_card() 
    :param metrics: metrics defined by metadata_eval_results for the model card
    """
